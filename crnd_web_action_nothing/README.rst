...
Crnd Web Action Nothing allows you to prevent the dialog box from closing when you click on a button that does not return an action by adding to the method code:
return { 'type': 'ir.actions.nothing' }
