...
| crnd_web_diagram_plus | CRnD Web Diagram Plus | LGPL-3 | 13.0.0.2.1 | Odoo Web Diagram view by CRnD. |  |
| crnd_web_list_popover_widget | CRND Web List Popover Widget | LGPL-3 | 13.0.0.4.3 | Tooltips message for text fields on tree view. |  |
| crnd_web_tree_colored_field | CRND web tree colored field | LGPL-3 | 13.0.0.2.0 |  |  |
| crnd_web_widget_popup_image | CRND Web Image Popup Widget | LGPL-3 | 13.0.0.1.0 | Popup images from the binary fields |  |
