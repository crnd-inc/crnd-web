...
CRND Web Action Readonly is designed to switch the view to readonly mode by adding code to the action method: return { 'type': 'ir.actions.readonly' }
